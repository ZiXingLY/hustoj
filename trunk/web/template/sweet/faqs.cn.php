...
<hr>
          ...
          <fieldset class="layui-elem-field">
              ...
              <div class="layui-field-box">
                  ...
                  <a href="http://openjdk.java.net/">openjdk-7</a> 编译 Java. 对应的编译选项如下:
          ...
          <fieldset class="layui-elem-field">
              <legend>A</legend>
              <div class="layui-field-box">
                  你的程序应该从标准输入 stdin('Standard Input')获取输入，并将结果输出到标准输出 stdout('Standard Output').例如,在C语言可以使用 'scanf' ，在C++可以使用'cin' 进行输入；在C使用 'printf' ，在C++使用'cout'进行输出.</p>
                  <p>用户程序不允许直接读写文件, 如果这样做可能会判为运行时错误 "<font color=green>Runtime Error</font>"。
              </div>
          </fieldset>
<p>
下面是 1000题的参考答案</p>
...
C:<br>
<pre class="layui-code"><font color="blue">
#include &lt;stdio.h&gt;
int main(){
    int a,b;
...
<hr>
          ...
          <fieldset class="layui-elem-field">
              <legend>A</legend>
              <div class="layui-field-box">
                  <a href=registerpage.php>注册</a> 一个帐号，然后就可以练习，点击比赛列表Contests可以看到正在进行的比赛并参加。
              </div>
          </fieldset>
